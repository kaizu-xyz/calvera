...
use calvera::{BusySpin, Producer, build_multi_producer_unchecked, build_uni_producer_unchecked};
...
fn disruptor_spsc() {
    ...
    let mut producer = build_uni_producer_unchecked(BUF_SIZE, factory, BusySpin)
...
fn disruptor_mpsc() {
    ...
    let mut producer1 = build_multi_producer_unchecked(BUF_SIZE, factory, BusySpin)
        .handle_events_with(processor)
        .build();
